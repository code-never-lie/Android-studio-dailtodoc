...
public class SignUp extends AppCompatActivity {
    ...
    private void initAllUi() {
        ...
        pass=(EditText)findViewById(R.id.signp_pass);
        phoneNumber=(EditText)findViewById(R.id.signup_phone_number);
        age=(EditText)findViewById(R.id.signp_user_Age);

        progressBar=(ProgressBar)findViewById(R.id.signup_progressbar);
        signup_up=(Button) findViewById(R.id.signup_btn);
        login_btn=(Button)findViewById(R.id.signup_btn_login);
        ...
        //casting
        userTypeRadioGroup=(RadioGroup)findViewById(R.id.user_type_radio_group);
        //initialize function
        user=new User();
    }
}
